...
function CdnController(){
    ...
    var clientArch = Meteor.isCordova ? "web.cordova" : Meteor.isModern ? "web.browser" : "web.browser.legacy"
		...
		} else if (isFromCDN && WebAppInternals.staticFilesByArch
			   && WebAppInternals.staticFilesByArch[clientArch] && !(pathname in WebAppInternals.staticFilesByArch[clientArch])){
